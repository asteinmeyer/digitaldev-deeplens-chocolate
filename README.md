...
IMPORTANT: Script must be run using python 2 and not python 3, so ensure python 2 is installed appropriately. Once you have done that, input the command: pip install mxnet==1.1.0.post0 to ensure mxnet is installed correctly.
